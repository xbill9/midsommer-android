...
class Game {
    ...
    initHighScores() {
        // Seed some scores if none exist
    ...
    saveScore(playerName, finalScore) {
        ...
        localStorage.setItem("midsommerScores", JSON.stringify(scores.slice(0, 5)));
        this.renderHighScores();
    }
    ...
    changeState(newState) {
        ...
        if (newState === this.states.TITLE) {
            ...
            document.getElementById("statEndScore").innerText = this.player ? this.player.score : 0;
            ...
            this.saveScore("Player Sven", totalScore);
            this.stopTimer();
            sounds.playSFX('win');
        }
    }
